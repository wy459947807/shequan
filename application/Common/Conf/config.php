...
if (file_exists("data/conf/data.php")) {
	$data = include 'data/conf/data.php';
} else {
	$data = array();
}
...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Wx','Comment','Demo','Tlive'),
        ...
        'SP_DEFAULT_THEME'		=> 'frontend',       // 前台模板文件
        ...
        'AUTOLOAD_NAMESPACE' => array('plugins' => './plugins/','util' => './simplewind/Lib/Util/'), //扩展模块列表
...
return  array_merge($configs,$db,$runtime_config,$data);
