...
define('DATELEVEL', 0);
define('APPID', 'h2M0adsdz7r0nbvc');         //应用id
define('APPSECRET', 'y2D0Ed0d77J06bTcQepccci3w6xeb2We');      //应用密钥
...
class Ucenter{
    ...
    public function synlogin($get, $post) {
         file_put_contents("uc3.txt", json_encode($get)); 
        if(!API_SYNLOGIN) {
        ...
        * $_SESSION['uid']=$uid;
        */
        file_put_contents("uc2.txt", json_encode($get)); 
