    ...
    $(document).ready(function(){
        ...
        $('#pay_platform').delegate('span','click',function(e){
            ...
            var mask = $('<div class="mask"></div>');
                $('body').append(mask);
            $.post('/payInterface_alipay/request.php',param,function(res){
                ...
                if(res.status === 500){
                    ...
                    if(curPage === 'orderInfo'){
                        $('body').popUpWin({
							content:function(){
								return '<img src="'+res.code_img_url+'" /><div class="msg_default_box"><i class="icon60_qr pngFix"></i><p>请使用支付宝钱包扫描<br>二维码以完成支付</p></div>';
							},
